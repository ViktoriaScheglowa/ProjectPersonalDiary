...
urlpatterns = [
    ...
    # API Views
    path(
        "api/moments/", PublicMomentsTemplateView.as_view(), name="public_moments_api"
    ),
    ...
    path(
        "api/<int:pk>/update/",
        MomentsUpdateAPIView.as_view(),
        name="moments_update_api",
    ),
    path(
        "api/<int:pk>/detail/",
        MomentsRetrieveAPIView.as_view(),
        name="moments_detail_api",
    ),
    path(
        "api/<int:pk>/delete/",
        MomentsDestroyAPIView.as_view(),
        name="moments_delete_api",
    ),
]
